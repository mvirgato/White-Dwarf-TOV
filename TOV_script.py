...
class mixed_WD:
    ...
    def M_P0_rel(self, M):
        ...
        file = 'results/{}{}/{:0.3e}/mass_rad/MR.dat'.format(self.elemOutter, self.elemInner, self.temp)
        data = pd.read_csv(file, header=0, sep = '\t')
    ...
    def TOV_mixed(self, P0, dr):
        ...
        rho_vals = [self.eosInner.rho_P(P)]
        ne_vals = [self.eosInner.ne(xws_now)]
        np_vals = [self.eosInner.np(xws_now)]
        mufe_vals = [self.eosInner.mufe(xws_now)]
        phi_vals = [phi_0]
        ...
        while (m_vals[-1] <= M_star*Msol/2):
            ...
            r_vals.append(TOV_sol.t[-1])
            m_vals.append(TOV_sol.y[0, -1])
            P_vals.append(TOV_sol.y[1, -1])
            phi_vals.append(TOV_sol.y[2, -1])
            ...
            rho_vals.append(self.eosInner.rho_P(P))
            ne_vals.append(self.eosInner.ne(xws_now))
            np_vals.append(self.eosInner.np(xws_now))
            mufe_vals.append(self.eosInner.mufe(xws_now))
        ...
        while True:
            ...
            P_vals.append(TOV_sol.y[1, -1])
            phi_vals.append(TOV_sol.y[2, -1])
            rho_vals.append(self.eosOutter.rho_P(P))
            ne_vals.append(self.eosOutter.ne(xws_now))
            np_vals.append(self.eosOutter.np(xws_now))
            mufe_vals.append(self.eosOutter.mufe(xws_now))
